...
def index(request):
    print(request.user)
    return render(request, "clarify/dashboard.html")


class DashboardView(View, LoginRequiredMixin):
    template_name = "clarify/dashboard.html"
...
class ConversationView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'clarify/conversations.html', {'messages': messages})
...
class AnalyticsView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'clarify/analytics.html', {'analytics': flat_analytics})


class ChatbotView(View):
    template_name = "clarify/chatbot_widget.html"
